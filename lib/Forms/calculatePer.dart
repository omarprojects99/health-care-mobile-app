...
class CalculatePer extends StatefulWidget {
  static const screenroute ='cal-screen';
  @override
  _CalculatePerState createState() => _CalculatePerState();
}

class _CalculatePerState extends State<CalculatePer> {
